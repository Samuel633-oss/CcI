// Copyright (c) 2014-present The Alara Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef ALARA_CHAINPARAMSBASE_H
#define ALARA_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between alara-cli and alarad)
 * of a given instance of the Alara system.
 */
